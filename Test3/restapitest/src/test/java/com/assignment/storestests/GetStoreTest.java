...
public class GetStoreTest extends BaseTest {
	...
	@Test
	public void getValidSpecificStore() {
		storeId = getStoreId();
	...
	@Test
	public void getInvalidSpecificStore() {
		response = StoreApi.getSpecificStore(inValidStoreId);
		System.out.println("Response:\n" + response.asString());
